...
import static com.grapeqin.project.core.ProjectConstant.BASE_PACKAGE;
import static com.grapeqin.project.core.ProjectConstant.CONTROLLER_PACKAGE;
import static com.grapeqin.project.core.ProjectConstant.MAPPER_INTERFACE_REFERENCE;
import static com.grapeqin.project.core.ProjectConstant.MAPPER_PACKAGE;
import static com.grapeqin.project.core.ProjectConstant.MODEL_PACKAGE;
import static com.grapeqin.project.core.ProjectConstant.SERVICE_IMPL_PACKAGE;
import static com.grapeqin.project.core.ProjectConstant.SERVICE_PACKAGE;
...
public class CodeGenerator {
	...
	private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc" +
			".Driver";

	private static final String PROJECT_PATH =
			System.getProperty("user.dir"); // 项目在硬盘上的基础路径
	...
	public static void genService(String tableName, String modelName) {
		try {
			...
			data.put("modelNameLowerCamel",
					tableNameConvertLowerCamel(tableName));
	...
	private static String tableNameConvertMappingPath(String tableName) {
		...
		return "/" + (tableName.contains("_") ?
				tableName.replaceAll("_", "/") : tableName);
	}
	...
	private static String packageConvertPath(String packageName) {
		return String.format(
				"/%s/", packageName.contains(".") ? packageName.replaceAll(
						"\\" + ".", "/") : packageName);
	}
}
